...
INSERT INTO account_settings (id, display_name, timezone, date_format, time_format, default_landing_page, default_task_view, appearance, compact_dashboard, default_provider_id, default_model, default_reasoning_level, default_max_output_tokens, provider_failure_behavior, structured_output_retry_limit, default_execution_mode, default_worker_runtime, max_concurrent_workers, default_job_timeout_seconds, default_merge_policy, default_unknown_network_policy, default_dependency_install_policy, default_push_task_branch_policy, auto_index_repositories, incremental_index_after_merge, index_source_code, index_tests, index_documentation, ignore_generated_files, context_strategy, completed_workspace_retention_days, failed_workspace_retention_days, worker_log_retention_days, audit_event_retention_days, monthly_cost_warning, monthly_cost_hard_stop, settings_version, created_at, updated_at)
VALUES ('default', 'Local user', 'UTC', 'YYYY-MM-DD', '24H', 'dashboard', 'board', 'system', FALSE, NULL, NULL, 'medium', NULL, 'PAUSE_AND_NOTIFY', 2, 'AUTONOMOUS', 'DOCKER', 1, 3600, 'REQUIRE_HUMAN', 'REQUIRE_HUMAN', 'ALLOW', 'ALLOW', FALSE, FALSE, TRUE, TRUE, TRUE, TRUE, 'BALANCED', 7, 30, 30, 90, NULL, NULL, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
