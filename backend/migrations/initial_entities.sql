...
VALUES ('d21cdbfb-c07b-5f9f-97ef-c36a180843fb', '00000000-0000-0000-0000-000000000001', 'INTERPRETER', 'Interpreter', '', TRUE, 'ollama', 'qwen3:4b', NULL, 'none', '', 'fixed', NULL, NULL, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO team_agent_profiles (id, team_id, role_kind, display_name, avatar, enabled, provider, model, harness, effort, supplemental_instructions, prompt_version, soft_budget_usd, hard_budget_usd, version, created_at, updated_at)
VALUES ('0c44ccc1-32cc-5dd0-b422-02b3743d0554', '00000000-0000-0000-0000-000000000001', 'DEVELOPER', 'Developer', '', TRUE, 'openai', 'gpt-5.6-terra', 'codex', 'medium', '', 'fixed', NULL, NULL, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO team_agent_profiles (id, team_id, role_kind, display_name, avatar, enabled, provider, model, harness, effort, supplemental_instructions, prompt_version, soft_budget_usd, hard_budget_usd, version, created_at, updated_at)
VALUES ('85d6de1a-c2f6-57e1-9639-335d38376bfa', '00000000-0000-0000-0000-000000000001', 'THINKER', 'Thinker', '', FALSE, 'openai', 'gpt-5.6-sol', 'codex', 'high', '', 'fixed', NULL, NULL, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO team_agent_profiles (id, team_id, role_kind, display_name, avatar, enabled, provider, model, harness, effort, supplemental_instructions, prompt_version, soft_budget_usd, hard_budget_usd, version, created_at, updated_at)
VALUES ('33365eea-f101-55dc-b14d-98e163da23f1', '00000000-0000-0000-0000-000000000001', 'REVIEWER', 'Reviewer', '', FALSE, 'openai', 'gpt-5.6-terra', 'codex', 'high', '', 'fixed', NULL, NULL, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
