...
async def capabilities() -> dict[str, Any]:
    ...
    return {
        "fixed_lifecycle_enabled": settings.new_fixed_lifecycle,
        ...
        "repository_rag_enabled": settings.repository_rag_enabled,
        "legacy_routing_enabled": settings.legacy_workflow_routing,
        "legacy_executor_enabled": settings.legacy_executor,
        "rollout": "operator-gated-validation",
        ...
        "pending_delivery_phases": [],
        "verification_pending": ["real-container-smoke", "authorized-live-ticket-benchmark"],
    }
